// import { Law } from "@/interface/WikiTypes"; // you’ll need to define this interface
const API_BASE_URL = `${process.env.NEXT_PUBLIC_API_BASE_URL}/laws`;

export const fetchAllLaws = async (): Promise<Law[] | null> => {
    try {
...
export const fetchLawById = async (id: number): Promise<Law | null> => {
    try {
