...
import RightPanel from "@/components/wiki/component/RightPanelTranslation";
...
function App() {
  ...
  return (
    <div className="w-full h-full flex flex-col bg-white m-0 p-0">
      ...
      <div className="flex text-xs justify-center w-full gap-40 ml-40 pt-4 mt-2 px-0">
        <Button color="red" width="8rem" onClick={() => console.log("Cancel")}>
          Cancel
        </Button>
        <Button color="blue" width="8rem" onClick={() => console.log("Submit")}>
          Submit
        </Button>
      </div>
    </div>
