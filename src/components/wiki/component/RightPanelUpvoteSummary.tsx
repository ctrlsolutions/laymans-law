...
interface RightPanelUpvoteSummaryProps {
  selectedChapter: string;
}

const RightPanelUpvoteSummary: React.FC<RightPanelUpvoteSummaryProps> = ({
  selectedChapter,
}) => {
      ...
      {filteredTranslations.length > 0 ? (
        <>
          {filteredTranslations.map((translation) => (
            <SummaryCard key={translation.id} translation={translation} />
          ))}
...
export default RightPanelUpvoteSummary;