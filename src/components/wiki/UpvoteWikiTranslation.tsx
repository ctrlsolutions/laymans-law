...
import RightPanel from "@/components/wiki/component/RightPanelUpvote";
...
function App() {
  ...
  return (
    <div className="w-full h-full flex flex-col bg-white m-0 p-0">
      ...
      <div className="flex items-center justify-between mb-4 mt-5 px-0">
        <h1 className="text-sm font-medium text-black ">Translation</h1>
      </div>
