...
const CaseContainer: React.FC<CaseContainerProps> = ({ children, count }) => {
    ...
    return (
        <>
        <div className="w-full h-[73%] p-5 shadow-[0px_4px_20px_0px_rgba(0,0,0,0.25)] rounded-3xl text-black flex flex-col items-center">
            ...
            <div className="relative self-start">
                <select
                    className="px-4 py-2 ml-3 rounded-lg bg-white shadow-md cursor-pointer"
                    value={selected}
