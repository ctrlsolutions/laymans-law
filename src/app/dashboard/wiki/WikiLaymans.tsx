...
const WikiHeader: React.FC<WikiHeaderProps> = ({ searchQuery, setSearchQuery }) => {
  ...
  const handleButtonClick = () => {
    router.push("/dashboard/wiki/vote-summary"); 
  }
...
const MainContent: React.FC<LawData> = ({ title, chapter, content, translation }) => (
  <article className="h-100% flex-1 px-10 py-10 pb-8 bg-white border border-gray rounded-2xl overflow-y-auto shadow-sm max-sm:hidden">
